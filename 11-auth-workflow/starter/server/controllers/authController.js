...
const register = async (req, res) => {
	...
	res.status(StatusCodes.OK).json({ msg: "Please check your email to verify the account" });
};
...
const verifyEmail = async (req, res) => {
	...
	if (!email || !verificationToken) {
		throw new CustomError.BadRequestError("Please provide email and verification token");
	}
	...
	if (verificationToken !== user.verificationToken) {
		throw new CustomError.UnauthenticatedError("Verification token not correct");
	}
